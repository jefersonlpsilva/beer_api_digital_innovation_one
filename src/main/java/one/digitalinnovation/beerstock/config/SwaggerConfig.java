...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Jeferson silva";
    private static final String CONTACT_GITHUB = "https://github.com/jefersonlpsilva";
    private static final String CONTACT_EMAIL = "jefersonsilvadev@hotmail.com";
